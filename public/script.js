...
function stopAI() {
    ...
    const typingMsg = document.querySelector(".ai-message.typing");
    if (typingMsg) {
        typingMsg.innerText = typingMsg.innerText; // freeze current
    }
}
...
async function aiRespond() {
    ...
    try {
        ...
        typingMsg.innerText = "Error connecting to AI.";
    }
}
